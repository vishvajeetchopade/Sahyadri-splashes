...
class VajraiDetail extends StatefulWidget {
  final int index;

  const VajraiDetail({super.key, required this.index});

  @override
  State<VajraiDetail> createState() => _DetailScreenState();
}

class _DetailScreenState extends State<VajraiDetail> {
  final List<Map<String, dynamic>> waterfalls = [
    {
      'name': 'Vajrai Waterfalls',
      'location': 'Kas,Satara',
      'rating': 4.8,
      'image': 'assets/Vajrai/vaj1.jpeg',
      ...
      'photos': [
        'assets/Vajrai/vaj1.jpeg',
        'assets/Vajrai/vaj2.jpg',
        'assets/Vajrai/vaj3.png',
        'assets/Vajrai/vaj4.jpg',
      ],
    },
  ];
